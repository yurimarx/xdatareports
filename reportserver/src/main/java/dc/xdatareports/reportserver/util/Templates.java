package dc.xdatareports.reportserver.util;
...
public class Templates {
    ...
    public static ComponentBuilder<?, ?> createVisumTitleComponent(String label) {
        
    	ComponentBuilder<?, ?> dynamicReportsVisumComponent = cmp.horizontalList(cmp.image(Templates.class.getResourceAsStream("br/com/visumconsult/reports/visum.png")).setFixedDimension(60, 60),
                                                     cmp.verticalList(cmp.text(label).setStyle(bold22CenteredStyle).setHorizontalTextAlignment(HorizontalTextAlignment.LEFT)));

    	return cmp.horizontalList()
                  .add(dynamicReportsVisumComponent, cmp.text(label).setStyle(bold18CenteredStyle).setHorizontalTextAlignment(HorizontalTextAlignment.RIGHT))
                  .newRow()
                  .add(cmp.line())
                  .newRow()
                  .add(cmp.verticalGap(10));
